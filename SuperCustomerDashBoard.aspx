<%@ Page Title="" Language="C#" MasterPageFile="MedicalAdminMain.master" AutoEventWireup="true" CodeFile="SuperCustomerDashBoard.aspx.cs" Inherits="CustomerFiles_CustomerDashBoard" %>
...
<head>
    ...
    <title>Super Customer Dashboard</title>
        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <div class="row">
                    ...
                    <!-- /row -->
                    <div class="row">                        
                        <a href="RequestMedicine.aspx">
                            <div class="col-md-3 col-sm-3 mb">
                                <div class="white-panel pn">
                                    <div class="white-header" style="background-color: #a3e258; color: black;">
                                        <h5>Request for new medicine</h5>
                                    </div>
                                    <div class="centered">
                                        <h1><i class="glyphicon glyphicon-asterisk" style="font-size: 170px; color: #a3e258;"></i></h1>
                                    </div>
                                </div>
                            </div>
                        </a>
                        <a href="Customer_Masterdashboard.aspx">
                            <div class="col-md-3 col-sm-3 mb">
                                <div class="white-panel pn">
                                    <div class="white-header" style="background-color: #e782ff; color: black;">
                                        <h5>Master</h5>
                                    </div>
                                    <div class="centered">
                                        <h1><i class="glyphicon glyphicon-globe" style="font-size: 170px; color: #e782ff;"></i></h1>
                                    </div>
                                </div>
                            </div>
                        </a>
                        <a href="Reports.aspx">
                            <div class="col-md-3 col-sm-3 mb">
                                <div class="white-panel pn">
                                    <div class="white-header" style="background-color: orange; color: black;">
                                        <h5>Report</h5>
                                    </div>
                                    <div class="centered">
                                        <h1><i class="glyphicon glyphicon-eye-open" style="font-size: 170px; color: orange;"></i></h1>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="CompanyCustomer.aspx">
                            <div class="col-md-3 col-sm-3 mb">
                                <div class="white-panel pn donut-chart">
                                    ...
                                    <div class="centered">
                                        <h1><i class="glyphicon glyphicon-leaf" style="font-size: 170px; color: #58e2d2"></i></h1>
                                    </div>
                                </div>
                                <! --/grey-panel -->
                            </div>
                          ...
                          <a href="Supplier.aspx">
                              <div class="col-md-3 col-sm-3 mb">
                                  <div class="white-panel pn">
                                      ...
                                      <div class="centered">
                                          <h1><i class="glyphicon glyphicon-log-out" style="font-size: 170px; color: #dfe258"></i></h1>
                                      </div>
                                  </div>
                              </div>
                          </a>
                          <a href="CustomerProduct.aspx">
                              <div class="col-md-3 col-sm-3 mb">
                                  <div class="white-panel pn">
                                      <div class="white-header" style="background-color: #e28a58; color: black;">
                                          <h5><strong>Product</strong></h5>
                                      </div>
                                      <div class="centered">
                                          <h1><i class="glyphicon glyphicon-cutlery" style="font-size: 170px; color: #e28a58"></i></h1>
                                      </div>
                                  </div>
                              </div>
                          </a>
