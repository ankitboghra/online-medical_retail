...
public partial class Report_Sales : System.Web.UI.Page
{
    ...
    protected void ExportToExcel()
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Report_Expiry_" + DateTime.Now+ ".xls");
        Response.Charset = "";
    ...
    protected void ExportToPDF()
    {
        using (StringWriter sw = new StringWriter())
        {
            using (HtmlTextWriter hw = new HtmlTextWriter(sw))
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Report_Expiry_" + DateTime.Now + ".pdf");
    ...
    private void ExportToWord()
    {
        ...
        Response.Charset = "";
        string FileName = "Report_Expiry_" + DateTime.Now + ".doc";
