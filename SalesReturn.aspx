<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesReturn.aspx.cs" Inherits="SalesReturn" ViewStateEncryptionMode="Never" validateRequest="false" EnableEventValidation="false"%>
<!DOCTYPE html>
...
<form id="Form2" runat="server" action="SalesReturn.aspx" >        
                    ...
                    <div class="col-md-9" style="background-color: none">
                        ...
                        <div class="row">
                            <div class="col-md-5" style="background-color: none">
                                ...
                                <asp:DropDownList ID="DDPatient" onchange="fillPendingAmo();" CssClass="form-control input-sm" runat="server" >
