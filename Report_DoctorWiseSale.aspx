<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_DoctorWiseSale.aspx.cs" Inherits="Report_Sales" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Doctor Wise Sales</title>
                        ...
                        <div class="well">
                            <div class="row">
                                ...
                                <div class="col-md-4 paddi">
                                    <span class="label" style="font-size: larger">Doctor Name</span><br />
                                    <asp:DropDownList ID="DDDoctorName" runat="server" CssClass="form-control input-md" DataSourceID="SqlDataSource1" DataTextField="DoctorName" DataValueField="DoctorId"></asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [DoctorId], [DoctorName] FROM [tbl_doctor]"></asp:SqlDataSource>
                                </div>
