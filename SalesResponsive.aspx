<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesResponsive.aspx.cs" Inherits="SalesResponsive" ViewStateEncryptionMode="Never" validateRequest="false" EnableEventValidation="false"  %>
...
<head runat="server">
    ...
    <script>        
        ...
        function fillPendingAmo()
        {
            var pId = document.getElementById("DDPatient").value.toString();
            var x = new XMLHttpRequest();
            x.open("POST", "ClientSide.aspx?id=" + pId + "&c=" + 5, false);
            x.send(null);
            var str = x.responseText;
            document.getElementById("txtPendingAmount").value = str.slice(0, str.search("-End1-"));
            document.getElementById("txtAddress").value = str.slice(str.search("-End1-") + 6, str.search("-End2-"));
            document.getElementById("HiddenPAmo").value = str.slice(0, str.search("-End1-"));
            document.getElementById("HiddenPAdd").value = str.slice(str.search("-End1-") + 6, str.search("-End2-"));
       }
    </script>
</head>
<body style="background-color: #55FFFF">
    <form id="Form1" runat="server" action="SalesResponsive.aspx" >        
                    ...
                    <div class="col-md-9" style="background-color: none">
                        <div class="row">
                            <div class="col-md-2" style="background-color: none;">
                                <span class="label sml">Sales</span>
                            ...
                            <div class="col-md-3" style="background-color: none">
                                <span class="label sml">Sales Date</span>
                        ...
                        <div class="row">
                            <div class="col-md-5" style="background-color: none">
                                <span class="label sml">Code number (Patient)</span>
                                <asp:DropDownList ID="DDPatient" onchange="fillPendingAmo();" CssClass="form-control input-sm" runat="server" OnSelectedIndexChanged="DDPatient_SelectedIndexChanged">
                            ...
                            <div class="col-md-4" style="background-color: none">
                                <span class="label sml">Patient Amount Pending</span>
                                <asp:TextBox class="form-control input-sm" ID="txtPendingAmount" placeholder="Patient Amount Pending" runat="server" ReadOnly="true"></asp:TextBox><br/>
                                <asp:HiddenField ID="HiddenPAmo" runat="server" />
                            </div>
                            <div class="col-md-3" style="background-color: none">
                                ...
                                <asp:HiddenField ID="HiddenPAdd" runat="server" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3" style="background-color: none">                       
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtpatientcontact" CssClass="form-control input-sm" runat="server" TextMode="SingleLine"></asp:TextBox>
                        </div>
                        <div class="form-group">
        ...
        <asp:Button ID="Button1" data-toggle="modal" Visible="false" data-target="#myMod" runat="server" Text="Button"/>
    </form>
</body>
</html>