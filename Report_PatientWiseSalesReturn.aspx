<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_PatientWiseSalesReturn.aspx.cs" Inherits="Report_Sales" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Patient Wise Sales Return</title>
            ...
            <div class="row">
                ...
                <div class="panel">
                    <div class="panel-heading text-center">
                        <h2>Patient Wise Sales Return Report</h2>
                    </div>
                        ...
                        <div class="well">
                            <div class="row">
                                ...
                                <div class="col-md-4 paddi">
                                    <span class="label" style="font-size: larger">Patient Name</span><br />
                                    <asp:DropDownList ID="DDPatientName" runat="server" CssClass="form-control input-md" DataSourceID="SqlDataSource1" DataTextField="PatientName" DataValueField="PatientId"></asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [PatientName], [PatientId] FROM [tbl_Patient]"></asp:SqlDataSource>
                                </div>
