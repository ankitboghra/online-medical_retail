<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_MedicineWiseExpiry.aspx.cs" Inherits="Report_Sales" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Medicine Wise Expiry</title>
            ...
            <div class="row">
                ...
                <div class="panel">
                    <div class="panel-heading text-center">
                        <h2>Medicine Wise Expiry Report</h2>
                    </div>
                        ...
                        <div class="well">
                            <div class="row">
                                ...
                                <div class="col-md-4 paddi">
                                    <span class="label" style="font-size: larger">Medicine Name</span><br />
                                    <asp:DropDownList ID="DDMedicineName" runat="server" CssClass="form-control input-md" DataSourceID="SqlDataSource1" DataTextField="Product_Name" DataValueField="Product_id"></asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Product_id], [Product_Name] FROM [tbl_product]"></asp:SqlDataSource>
                                </div>
